...
export function getProductSupplierSource(product: Pick<Product, 'brand' | 'imageUrl' | 'supplierSource'>) {
  ...
  if (product.imageUrl.includes('doubleyellowsquash.com')
    || product.imageUrl.includes('unsquashable.com')
    || product.imageUrl.includes('cdn.shopify.com/s/files/1/0510/5264/2502')) {
    return supplierSourceByBrand.unsquashable;
  }

  if (product.imageUrl.includes('karakal.com')
    || product.imageUrl.includes('cdn.shopify.com/s/files/1/0648/8322/8918')) {
    return supplierSourceByBrand.karakal;
  }
...
export const products: Product[] = [
  {
    ...
    stock: 0,
    supplierSource: 'Unsquashable - https://unsquashable.com/products/unsquashable-miguel-rodriguez-autograph-squash-racket',
  ...
  {
    sku: 'SQ-002',
    name: 'Karakal Raw Pro 2.2 Joel Makin',
    categorySlug: 'squash',
    type: 'Racket',
    brand: 'Karakal',
    price: '€129.00',
    details: 'Tour-spec squash frame developed with Joel Makin for quick handling and stable contact.',
    badges: ['Control', 'Power'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-raw-pro-2-2-joel-makin-signature-squash-racket',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/files/KARAKAL-KS25000-01_a31a45b5-1e10-42c5-9719-5ed7097bf5d6.webp?v=1749467369&width=900',
  },
  {
    sku: 'SQ-003',
    name: 'Karakal PU Super Grip Pack of 2',
    categorySlug: 'squash',
    type: 'Grip',
    brand: 'Karakal',
    price: '€8.90',
    details: 'Dual-pack replacement grip for weekly players who rotate rackets.',
    badges: ['Grip', 'Popular'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-pu-super-grip-pack-of-2',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/files/karakal-pu-super-grip-pack-of-two-02.webp?v=1784548209&width=900',
  },
  {
    sku: 'SQ-004',
    ...
    badges: ['Bag', 'Travel'],
    stock: 0,
    supplierSource: 'Unsquashable - https://unsquashable.com/products/unsquashable-tour-tec-pro-deluxe-racket-bag',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0510/5264/2502/products/UNSQUASHABLETOUR-TECPRODeluxeRacketBag2angle.jpg?v=1724404422&width=900',
  },
  {
    sku: 'TN-001',
    name: 'Karakal Graphite Lite 260 Tennis Racket',
    categorySlug: 'tennis',
    type: 'Racket',
    brand: 'Karakal',
    price: '€149.00',
    details: 'Fast Fibre graphite tennis frame for game-improving players who want spin and acceleration.',
    badges: ['Tennis', 'All Court'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-graphite-lite-260-tennis-racket',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/files/KARAKAL-KT37231.webp?v=1726835895&width=900',
  },
  {
    sku: 'TN-002',
    name: 'Karakal X-TAK Overwrap Grip 3 Pack',
    categorySlug: 'tennis',
    type: 'Grip',
    brand: 'Karakal',
    price: '€10.50',
    details: 'Ultra-thin tacky overgrip blister pack for reliable traction through long sessions.',
    badges: ['Grip', '3 Pack'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-xtak-overwrap-grip',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/products/KARAKALX-TAKGRIP.webp?v=1657142026&width=900',
  },
  {
    sku: 'TN-003',
    name: 'Karakal Pro Tour Match 2.2 Racket Bag',
    categorySlug: 'tennis',
    type: 'Bag',
    brand: 'Karakal',
    price: '€69.00',
    details: 'Four-racket match bag with shoulder straps, grab handles and side accessory pockets.',
    badges: ['Bag', '4R'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-pro-tour-match-2-2-racket-bag-white',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/files/KARAKAL-KZ97950-02_20602cf8-0b1d-40d1-8d41-1550f5f6fd9a.webp?v=1749467164&width=900',
  },
  {
    sku: 'TT-001',
    name: 'Karakal KTT 500 Table Tennis Bat',
    categorySlug: 'table-tennis',
    type: 'Racket',
    brand: 'Karakal',
    price: '€54.00',
    details: 'Club-level offensive bat for rallies and spin play.',
    badges: ['Bat', 'Spin'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-ktt-500-table-tennis-bat',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/products/KARAKAL-KD926.webp?v=1657703167&width=900',
  },
  {
    sku: 'TT-002',
    name: 'Karakal 3 Star Table Tennis Balls',
    categorySlug: 'table-tennis',
    type: 'Balls',
    brand: 'Karakal',
    price: '€6.50',
    details: 'Match-grade table tennis balls for steady bounce and durability.',
    badges: ['Balls', 'Match'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-3-star-table-tennis-balls',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/products/KARAKAL3STARTABLETENNISBALLS.webp?v=1657705191&width=900',
  },
  {
    sku: 'TT-003',
    name: 'Karakal Pro Tour Fifty 2.2 Short Racket Bag',
    categorySlug: 'table-tennis',
    type: 'Bag',
    brand: 'Karakal',
    price: '€47.50',
    details: 'Compact four-racket bag sized for table tennis, padel and racketball.',
    badges: ['Bag', 'Cover'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-pro-tour-fifty-2-2-short-racket-bag-white',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/files/KARAKAL-KZ97940-02.webp?v=1749467333&width=900',
  },
  {
    sku: 'BD-001',
    name: 'Karakal BN60 FF Badminton Racket',
    categorySlug: 'badminton',
    type: 'Racket',
    brand: 'Karakal',
    price: '€89.00',
    details: 'Lightweight Fast Fibre badminton frame for quick exchanges and overhead speed.',
    badges: ['Badminton', 'Lightweight'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-bn60-ff-badminton-racket',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/files/KARAKAL-KB23000_236c104b-07f2-4776-8af0-13c5be084d1f.webp?v=1726835895&width=900',
  },
  {
    sku: 'BD-002',
    ...
    brand: 'Karakal',
    price: '€4.20',
    details: 'Classic tacky replacement grip for badminton and racket handles.',
    badges: ['Grip', 'Classic'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-pu-super-grip',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/files/KARAKAL-KA665S-06.webp?v=1751641132&width=900',
  },
  {
    sku: 'BD-003',
    name: 'Karakal Red Fast National Shuttlecocks',
    categorySlug: 'badminton',
    type: 'Balls',
    brand: 'Karakal',
    price: '€14.00',
    details: 'Durable nylon shuttle set for training and recreational matches.',
    badges: ['Shuttle', 'National'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-red-fast-national-shuttlecocks',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/products/KARAKALFASTREDSHUTTLECOCKS.webp?v=1761755990&width=900',
  },
  {
    sku: 'PD-001',
    name: 'Karakal Padel FF 365',
    categorySlug: 'padel',
    type: 'Racket',
    brand: 'Karakal',
    price: '€169.00',
    ...
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-padel-ff-365',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/files/KARAKAL-KP22001.webp?v=1726835895&width=900',
  },
  {
    sku: 'PD-002',
    name: 'Karakal X-TAK Overwrap Grip 3 Pack',
    ...
    brand: 'Karakal',
    price: '€11.00',
    details: 'Sweat-ready overgrip blister pack for padel, tennis and squash handles.',
    badges: ['Padel', 'Grip'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-xtak-overwrap-grip',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/products/KARAKAL-KA701.webp?v=1657142192&width=900',
  },
  {
    sku: 'PD-003',
    name: 'Karakal Pro Tour Fifty 2.2 Padel Bag',
    categorySlug: 'padel',
    type: 'Bag',
    brand: 'Karakal',
    price: '€74.00',
    details: 'Compact padel bag with wet/dry compartments and space for up to four rackets.',
    badges: ['Padel', 'Team Bag'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-pro-tour-fifty-2-2-padel-bag-white',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/files/KARAKAL-KZ97940-02.webp?v=1749467333&width=900',
  },
  {
    sku: 'PD-004',
    name: 'Karakal Pro Tour Tee Black',
    categorySlug: 'padel',
    type: 'Wear',
    brand: 'Karakal',
    price: '€34.00',
    ...
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-pro-tour-tee-black-2025-26',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/files/ProTee-Black-01_0c88254a-a13a-42f0-9131-9581610b1ba0.webp?v=1766148732&width=900',
  },
  {
    sku: 'SQ-005',
    name: 'Karakal Pro Tour Tee Blue',
    categorySlug: 'squash',
    type: 'Wear',
    brand: 'Karakal',
    price: '€32.00',
    ...
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-pro-tour-tee-blue-2025-26',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/files/ProTee-Blue-01.webp?v=1749467056&width=900',
  },
  {
    sku: 'TN-004',
    name: 'Karakal Head Crashtape',
    categorySlug: 'tennis',
    type: 'Accessory',
    brand: 'Karakal',
    price: '€7.00',
    details: 'Racket head protection tape for cleaner impact feel and frame durability.',
    badges: ['Accessory', 'Tape'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-head-crashtape',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/files/karakal-head-crashtape-ka605_842876b6-14cc-44ea-a412-8b0053170651.webp?v=1780571162&width=900',
  },
  {
    sku: 'BD-004',
    name: 'Karakal Pro Tour 30 2.2 Backpack',
    categorySlug: 'badminton',
    type: 'Bag',
    brand: 'Karakal',
    price: '€58.00',
    details: 'Multi-sport backpack for badminton, training kit and accessories.',
    badges: ['Bag', 'Everyday'],
    stock: 0,
    supplierSource: 'Karakal - https://karakal.com/products/karakal-pro-tour-30-2-2-backpack-white',
    imageUrl: 'https://cdn.shopify.com/s/files/1/0648/8322/8918/files/KARAKAL-KZ97955-01.webp?v=1749467010&width=900',
  },
